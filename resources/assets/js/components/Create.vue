<template>
    <div>
        ...
        <div class="cp-Private_Area">
            ...
            <input type="text" name="password" id="password" class="cp-RadioBox_Secret form-control" placeholder="Please enter a password." :disabled="state" required minlength="8" maxlength="32">
        </div>
    </div>
</template>
