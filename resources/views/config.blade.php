        ...
        <div class="st-Container">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ url('/api/user/update') }}" class="su-Form">
                ...
                <div class="su-ScreenName row">
                    ...
                    <div class="col">
                        <input id="screen-name" type="text" name="screen_name" value="{{ Auth::user()->screen_name }}" class="su-ScreenName_Textbox form-control" required autofocus>
                    </div>
                </div>
                <div class="su-Id row">
                    <label for="user_id" class="su-Id_Title align-self-center">ユーザID</label>
                    <div class="col">
                        <input id="user_id" type="text" name="user_id" value="{{ Auth::user()->user_id }}" class="su-Id_Textbox form-control" required autofocus>
                    </div>
                </div>
                <div class="su-Password row">
                    <label for="password" class="su-Password_Title align-self-center">パスワード</label>
                    <div class="col">
                        <input id="password" type="password" name="password" class="su-Password_Textbox form-control" required>
                    </div>
                </div>
                <div class="su-Confirm row">
                    <label for="password-confirm" class="su-Confirm_Title align-self-center">パスワード（確認）</label>
                    <div class="col">
                        <input id="password-confirm" type="password" name="password_confirm" class="su-Confirm_Textbox form-control" required>
                    </div>
                </div>
