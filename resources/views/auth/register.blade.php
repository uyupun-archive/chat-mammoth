    ...
    <div class="st-Container">
        ...
        <form method="POST" action="{{ route('register') }}" class="su-Form">
            ...
            <div class="su-Id row">
                ...
                <div class="col">
                    <input id="user_id" type="text" name="user_id" value="{{ old('user_id') }}" class="su-Id_Textbox form-control" required maxlength="16">
                </div>
            </div>
            ...
            <div class="su-Confirm row">
                ...
                <div class="col">
                    <input id="password-confirm" name="password_confirmation" type="password" class="su-Confirm_Textbox form-control" required maxlength="32">
                </div>
            </div>
