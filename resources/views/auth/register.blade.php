    ...
    <div class="st-Container">
        ...
        <form method="POST" action="{{ route('register') }}" class="su-Form">
            ...
            <div class="su-ScreenName row">
                ...
                <div class="col">
                    <input id="screen-name" type="text" name="screen_name" value="{{ old('screen-name') }}" class="su-ScreenName_Textbox form-control" required autofocus>
                </div>
            </div>
            <div class="su-Id row">
                <label for="user_id" class="su-Id_Title align-self-center">ユーザID</label>
                <div class="col">
                    <input id="user_id" type="text" name="user_id" value="{{ old('user_id') }}" class="su-Id_Textbox form-control" required autofocus>
                </div>
            </div>
            ...
            <div class="su-Confirm row">
                ...
                <div class="col">
                    <input id="password-confirm" name="password_confirmation" type="password" class="su-Confirm_Textbox form-control" required>
                </div>
            </div>
